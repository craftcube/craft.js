(function () {
    angular.module('craft.widgets.ColorPicker',[]).directive('aceColorpicker', function () {
        return {
            restrict: 'EA',
            replace: true,
            scope: {
