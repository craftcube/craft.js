...
(function(){
    "use strict";
    angular.module('craft.auth.AuthService', ['craft.api.cap', 'craft.auth.handler']);
...
(function () {
    'use strict';
    angular.module('craft.auth.session', ['craft.auth.handler', 'craft.auth.AuthService','craft.auth.UserStorage', 'craft.widgets.toast']);
    ...
    angular.module('craft.auth.session').controller('UserProfileCtrl', ['$scope', 'SessionAuthService', 'AuthHandlerService' ,'ngToast', UserProfileCtrl]);

    function UserProfileCtrl($scope, SessionAuthService, AuthHandlerService, ngToast) {
